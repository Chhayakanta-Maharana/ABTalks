      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-9 h-9 rounded-xl navy-glass border border-[rgba(148,163,184,0.12)] flex items-center justify-center text-[#94A3B8] hover:text-white hover:border-[#3B82F6]/50 transition-all"
          >
